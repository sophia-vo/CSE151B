...
# Start at 8 on Mac/Metal. Try 12 or 16 once stable.
CONCURRENCY = 8
...
# ── Prompts ────────────────────────────────────────────────────────────────────
# No "expert mathematician" persona.
# These prompts describe the desired behavior directly.
...
async def run_inference() -> None:
    ...
    pass_configs = [
        ...
        # Pass 1: decisive retry.
        # This is the important new pass:
        # stop once an answer is found; don't analyze unused MCQ options.
        {
            "max_tokens": 2048,
            "temperature": 0.35,
            "top_p": 0.90,
        ...
        # Pass 3+: ultra-short deterministic retry.
        {
            "max_tokens": 512,
            "temperature": 0.0,
            "top_p": 1.0,
